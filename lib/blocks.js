...
BlockController.prototype.blockHeader = function(req, res, next) {
	...
	//doesn't work correctly in colx: self.node.services.bitcoind.getBlockHeader(hash, function(err, info) {
...
BlockController.prototype.blockIndex = function(req, res) {
  ...
  //not working with height and incomplete in colx: this.node.services.bitcoind.getBlockHeader(parseInt(height), function(err, info) {
